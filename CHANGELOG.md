...
## [3.0.0](https://github.com/TexteaInc/json-viewer/compare/json-viewer-v3.2.1...json-viewer-v3.0.0) (2023-10-09)
...
* component ObjectKeyModal ([#6](https://github.com/TexteaInc/json-viewer/issues/6))
...
* add helper function `createDataType` ([#60](https://github.com/TexteaInc/json-viewer/issues/60)) ([26b7a76](https://github.com/TexteaInc/json-viewer/commit/26b7a76c0ca1b5a1eb1796a805787278103d9c01))
* add hover effect ([#77](https://github.com/TexteaInc/json-viewer/issues/77)) ([c2a9dda](https://github.com/TexteaInc/json-viewer/commit/c2a9ddad43e2367c7c7e023de3be73b7d53df410))
* backport support for `props.displayDataTypes` ([#63](https://github.com/TexteaInc/json-viewer/issues/63)) ([7ff2d4d](https://github.com/TexteaInc/json-viewer/commit/7ff2d4de104d307fd4cd2cc6ab80c76698db0b2e))
* backport support for `props.quotesOnKeys` and `props.sortKeys` ([#48](https://github.com/TexteaInc/json-viewer/issues/48)) ([2cff791](https://github.com/TexteaInc/json-viewer/commit/2cff7916f2c93353e80a6746a091c14a137e4e50))
...
* collapse all empty iterables and disable expanding them ([#123](https://github.com/TexteaInc/json-viewer/issues/123)) ([5af0122](https://github.com/TexteaInc/json-viewer/commit/5af012280bc1a3d46e7c00e4088eecd7d289570b))
* enhance function dataType ([#81](https://github.com/TexteaInc/json-viewer/issues/81)) ([4cb6930](https://github.com/TexteaInc/json-viewer/commit/4cb6930b3b78d9715d14ed50b116b6013679402c))
...
* invert logic for showing dots ([#122](https://github.com/TexteaInc/json-viewer/issues/122)) ([a2f2145](https://github.com/TexteaInc/json-viewer/commit/a2f21458ae18230ecef40e08b3f6ebc44f6f13a6))
...
* object expand by click on dots ([#76](https://github.com/TexteaInc/json-viewer/issues/76)) ([ad1c4ba](https://github.com/TexteaInc/json-viewer/commit/ad1c4ba98668cddbdd912f790e7ce8ff2adc9a72))
...
* support `bigint` type ([#35](https://github.com/TexteaInc/json-viewer/issues/35)) ([71933e2](https://github.com/TexteaInc/json-viewer/commit/71933e2c9fb0637d13f62fbddb19c5027b02552d))
* support `displayObjectSize` ([#102](https://github.com/TexteaInc/json-viewer/issues/102)) ([98181bb](https://github.com/TexteaInc/json-viewer/commit/98181bb76ebfddaf72a60b2c6eaafdaa79c1cec6)), closes [#101](https://github.com/TexteaInc/json-viewer/issues/101)
...
* support `onSelect` callback ([#238](https://github.com/TexteaInc/json-viewer/issues/238)) ([e89a380](https://github.com/TexteaInc/json-viewer/commit/e89a380bb4251e3a6b7486b608bf7a4171b48ff3))
* support `props.collapseStringsAfterLength` with false ([#97](https://github.com/TexteaInc/json-viewer/issues/97)) ([1886a7a](https://github.com/TexteaInc/json-viewer/commit/1886a7a6af8b6926beb77ca6d706b1eb9616d433))
...
* support `props.onCopy` ([#113](https://github.com/TexteaInc/json-viewer/issues/113)) ([da757e1](https://github.com/TexteaInc/json-viewer/commit/da757e1432ebc8a6f2473923ff28e924eff28aa9))
...
* support browser ([#53](https://github.com/TexteaInc/json-viewer/issues/53)) ([57a72ab](https://github.com/TexteaInc/json-viewer/commit/57a72abc3cd025025bbc820a261ac5a52f9dd6d4))
...
* support path in dataType ([#107](https://github.com/TexteaInc/json-viewer/issues/107)) ([dad14b9](https://github.com/TexteaInc/json-viewer/commit/dad14b9b6b069d8261d12cfa0ff1ed3901555d46))
* support plugin system ([fdf9962](https://github.com/TexteaInc/json-viewer/commit/fdf996241683cc1b642bbd232d4a94b8874b9918))
* **ui:** replace triple dots (...) with ellipsis (…) ([#165](https://github.com/TexteaInc/json-viewer/issues/165)) ([bbb0dbd](https://github.com/TexteaInc/json-viewer/commit/bbb0dbdb8bc1078b9d5690c83ecac4a78d2b2b1f))
...
* add compare function in baseCellType Editor ([4dd5bda](https://github.com/TexteaInc/json-viewer/commit/4dd5bda27c3ce601b65994f6d7e3af5d9b07380a))
* add license in package.json ([930f128](https://github.com/TexteaInc/json-viewer/commit/930f128e03ddc6f24fa693d0cd48253c1a344274))
* add vite as dev dependency ([#148](https://github.com/TexteaInc/json-viewer/issues/148)) ([e34c35e](https://github.com/TexteaInc/json-viewer/commit/e34c35e38a532b9daeea512763cfd06e15645e6d))
* basic example ([151282e](https://github.com/TexteaInc/json-viewer/commit/151282e718453bfe446772389d7e14dbeafafd1d))
...
* browser field cause vite build fail ([#85](https://github.com/TexteaInc/json-viewer/issues/85)) ([2356ce4](https://github.com/TexteaInc/json-viewer/commit/2356ce4ce8c16fcffe82a4f88abff10d60482a44))
* bugs ([c966281](https://github.com/TexteaInc/json-viewer/commit/c966281d1c6913948f8d60387f8a2acaefb8a6c7))
* build issues ([95b1ba8](https://github.com/TexteaInc/json-viewer/commit/95b1ba8940e1e201dcf0ad1f69ea2e740ff3b2ec))
* cannot resolve `@textea/dev-kit/utils` ([#134](https://github.com/TexteaInc/json-viewer/issues/134)) ([f9560c3](https://github.com/TexteaInc/json-viewer/commit/f9560c3670e9f2f125b0dbe3359cbbc061c7e32b))
...
* correct types reference ([#219](https://github.com/TexteaInc/json-viewer/issues/219)) ([db23186](https://github.com/TexteaInc/json-viewer/commit/db23186d1e712c4f1f1d4c6a4a44ed5a6e0f037a))
...
* disable ssr in function inspect ([8eefe57](https://github.com/TexteaInc/json-viewer/commit/8eefe57f65e6fca2f27a2265c1e842b7cb8be77c))
* editable for basic value ([#95](https://github.com/TexteaInc/json-viewer/issues/95)) ([7d0e771](https://github.com/TexteaInc/json-viewer/commit/7d0e77145ea4bc4302bd3544323cae776aaa5a59))
...
* **example:** add netlify badge ([c1f6ac9](https://github.com/TexteaInc/json-viewer/commit/c1f6ac906821bc0adc1fbd46f41038218d508e13))
* **example:** image url match ([500f308](https://github.com/TexteaInc/json-viewer/commit/500f308acac238f87c5cc29290b5c0b6dfe5b307))
* exports default ([9a96901](https://github.com/TexteaInc/json-viewer/commit/9a969017fde3a288578fa1025d440dd24dd93963))
...
* ignore error when key of Map is an object ([da2053e](https://github.com/TexteaInc/json-viewer/commit/da2053e933122604b17cfc4dc2ab394969431109))
* ignore rootName when its false ([#57](https://github.com/TexteaInc/json-viewer/issues/57)) ([58121f9](https://github.com/TexteaInc/json-viewer/commit/58121f9ca6af7d0ac7c9154331942cadd7ef266f))
...
* inline icons from `@mui/icons-material` ([#147](https://github.com/TexteaInc/json-viewer/issues/147)) ([4fd6f11](https://github.com/TexteaInc/json-viewer/commit/4fd6f11d2551af4172616e6ecc873de80aae3202))
* key and value text should be selectable ([#217](https://github.com/TexteaInc/json-viewer/issues/217)) ([f7576ea](https://github.com/TexteaInc/json-viewer/commit/f7576eafea26b5ae18e0b0181a42d50ca6e7b3c2))
* migrate zustand away from `zustand/context' ([ccf07fa](https://github.com/TexteaInc/json-viewer/commit/ccf07fa81cb12e759b082b6a0b0fabd83b1d2b82))
* migrate zustand to v4 ([bdb0eab](https://github.com/TexteaInc/json-viewer/commit/bdb0eab2f1a8561d02da3200e86b388d030d730d))
* missing `props.defaultInspectDepth` ([#40](https://github.com/TexteaInc/json-viewer/issues/40)) ([b1c2948](https://github.com/TexteaInc/json-viewer/commit/b1c294840876c5127721474b1f30c57739e8e78d))
...
* move eslint related deps to devDependencies ([#142](https://github.com/TexteaInc/json-viewer/issues/142)) ([e2a5f2f](https://github.com/TexteaInc/json-viewer/commit/e2a5f2fe86b273caa3b5468ffc3aa5d7fa13f14a))
...
* move type registry into component state ([#64](https://github.com/TexteaInc/json-viewer/issues/64)) ([b70e628](https://github.com/TexteaInc/json-viewer/commit/b70e6287444194e01ba168ad0213bb499c2d0540))
* **next:** indent width ([dfafd4b](https://github.com/TexteaInc/json-viewer/commit/dfafd4bc3fffd720dddb616c6e7886e2bd927a38))
* reduce MUI size by using `@swc/plugin-transform-imports` ([#169](https://github.com/TexteaInc/json-viewer/issues/169)) ([8cf9039](https://github.com/TexteaInc/json-viewer/commit/8cf9039ba03a335e2d96f1651b39e8aa2b25dcb3))
...
* remove `workspaces` in `package.json` before release ([#143](https://github.com/TexteaInc/json-viewer/issues/143)) ([2b843f9](https://github.com/TexteaInc/json-viewer/commit/2b843f90ef690349cb4c592adba4cb2ffbcf9843))
* remove export default ([2da4983](https://github.com/TexteaInc/json-viewer/commit/2da4983f5f015650b637e76040e5a3c417753664))
* remove export default ([339640b](https://github.com/TexteaInc/json-viewer/commit/339640b9b7efe4def049789580cef59405e72cf6))
* remove scripts when publishing ([b3497b1](https://github.com/TexteaInc/json-viewer/commit/b3497b1f090ccea742a6ceabb3b85c85769774c8))
* replace `Object.hasOwn` ([7cdc134](https://github.com/TexteaInc/json-viewer/commit/7cdc134abf8091bc900a57e062f3c9b86f453edc))
* set `overflowWrap` to `anywhere` ([#99](https://github.com/TexteaInc/json-viewer/issues/99)) ([7d98cf6](https://github.com/TexteaInc/json-viewer/commit/7d98cf68c2a7bba086ff2cdcff0d0f722f86991d))
* set editable to false by default ([#69](https://github.com/TexteaInc/json-viewer/issues/69)) ([02f6790](https://github.com/TexteaInc/json-viewer/commit/02f6790a9e1013a32bad7198a471746032e535a1))
* set target as `ES5` ([598d229](https://github.com/TexteaInc/json-viewer/commit/598d229510839e70e327a0c4fcf29f82744a8f22))
* show three dots only on collapsed strings ([#118](https://github.com/TexteaInc/json-viewer/issues/118)) ([992c9f1](https://github.com/TexteaInc/json-viewer/commit/992c9f1be0c6651c083eca9c197d2665eaedbf8e))
* simplify if conditions ([#70](https://github.com/TexteaInc/json-viewer/issues/70)) ([248990c](https://github.com/TexteaInc/json-viewer/commit/248990c0bcbab1b134790303a3d989a000e15632))
* some enhancements ([#78](https://github.com/TexteaInc/json-viewer/issues/78)) ([25b23eb](https://github.com/TexteaInc/json-viewer/commit/25b23ebd548b434e3366a6ab833743f3f6181599))
...
* style add padding to `null` and `undefined` ([#50](https://github.com/TexteaInc/json-viewer/issues/50)) ([1c724d6](https://github.com/TexteaInc/json-viewer/commit/1c724d676f80219d4955002ee887ca105db97e4e))
...
* throw error if change '__proto__' ([790d99d](https://github.com/TexteaInc/json-viewer/commit/790d99de31316fbc5951d8ef98556d9c8c3c1aab))
...
* type registry runs multiple times ([#67](https://github.com/TexteaInc/json-viewer/issues/67)) ([c3daa8e](https://github.com/TexteaInc/json-viewer/commit/c3daa8e3afbc91149ad329a2e7bbcb234872133a))
...
* **ui:** remove left margin in key-value separator ([#153](https://github.com/TexteaInc/json-viewer/issues/153)) ([16e0903](https://github.com/TexteaInc/json-viewer/commit/16e0903424badc25ba52852864d959073da0cbe3))
* use `base0A` for highlight color ([4483e51](https://github.com/TexteaInc/json-viewer/commit/4483e51e6040963b1e3f25ff800165b6c7f5164a))
* use ES2018 as target ([1d06313](https://github.com/TexteaInc/json-viewer/commit/1d063139a949d2602d04fa511658c3990766de89))
* use swc in the right way ([4b437fb](https://github.com/TexteaInc/json-viewer/commit/4b437fb842462add8a16de649748d739b30307a9))


### Documentation

* fix install step  ([04a3893](https://github.com/TexteaInc/json-viewer/commit/04a3893dfbc16f7aa5cd52b062f32d48cb10e30b))
